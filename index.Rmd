...
fig1a<- ggplot(plot_ash1, aes(x = age, y = sns_freq_use)) +
  ...
  theme_bw() +
  labs(title = "Figure 1.",
    subtitle = "Relation between age and frequency of social media use as a function of social media site",
       x = "Age", 
       y = "Frequency of Social Media Use",
...
fig1b <- plot_ash1 %>%
  ...
  ggplot(aes(x = sns, y = freq_sns_mean)) +
    ...
    labs(subtitle = "Frequency of social media use as a function of social media site",
        x = "Social Media Site",
        y = "Frequency of Social Media Use",
        colour = "")
...
fig1c <- plot_ash1 %>%
  ...
  ggplot(aes(x = age, y = freq_sns_mean)) +
    ...
    theme_bw() +
    theme(legend.position = "") +
    labs(subtitle = "The relation between age and frequency of social media use",
        x = "Age",
        y = "Frequency of Social Media Use")

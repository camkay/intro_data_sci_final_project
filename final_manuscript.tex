...
\abstract{
The present research examined individual differences in interactions
with social media content and media consumption in American adults.
Secondary data analyses were conducted using an early 2018 phone survey
collected by the Pew Research Center (2018). Results showed that age is
associated with lower social media use overall but there are differences
with preferred social media site; both Snapchat and Twitter are used
more frequently than Facebook. Male respondents reported less frequency
...
than younger respondents and books in print were read less than those in
electronic formats. A marginal interaction between age and media format
suggests that the amount of media consumed increases with age more for
individuals using exclusively electronic or audiobook formats than fror
those using exclusively print or mixed media formats.
...
(Version 0.9.3; Wilke, 2018), \emph{dplyr} (Version 0.7.7; Wickham,
...
(Version 0.20.35; Sarkar, 2008), \emph{lme4} (Version 1.1.18.1; Bates,
...
2018), \emph{pander} (Version 0.6.2; Daróczi \& Tsegelskyi, 2018),

...
source(here::here("functions", "numbers2words.R")) # a cool function I found on github from James Fox (https://github.com/ateucher/useful_code/blob/master/R/numbers2words.r)

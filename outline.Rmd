...
### 2) Description of preparatory work that will need to be completed
  ...
  + **Tidying and Wrangling Data**
      + Considering we will need to create at least two graphs and one table, the bulk of work will consist of tidying the data.
  ...
  + **Requirement (c)**
      + We will create at least two graphs
        + Tentative graph 1: geom_point with geom_smooth with method "lm"
          + x-axis: age
          + y-axs: time_spent_on_social_media_site
          + colour: social_media_site
  + **Requirement (d)**
      + We will create one table depicting relevant summary statistics
      + Depending on what we uncover (and on how motivated we feel), we may include a summary of a fitted model
